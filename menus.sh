...
show_help() {
    ...
    echo "1. Place your video files in: $INPUT_DIR"
    echo "2. Run the script: bash main.sh"
    echo "3. Select your desired operation from menu"
    echo "4. Processed files will be in: $OUTPUT_DIR"
    echo
